...
class PoissonModel:
    def __init__(self, data, hiperparams, nsim=10000):
        ...
        # En Gamma: alpha es la forma (shape) y beta es la tasa (rate)
        self.alpha_hp = hiperparams[0] # r_hp o a
        self.beta_hp = hiperparams[1]  # lambda_hp o b
        self.nsim = nsim 
    ...
    def posteriori(self, show=False):
        # 1. Parámetros del posterior (Actualización Gamma-Poisson)
