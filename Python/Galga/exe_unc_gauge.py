...
input_hg = {"muestra": np.random.normal(1, 0.01, size=10), "name": "hg", "resol": 0.001, "calib": 0.002}
input_L = {"muestra": np.random.normal(1, 0.01, size=10), "name": "L", "resol": 0.001, "calib": 0.002}
input_x = {"muestra": np.random.normal(1, 0.01, size=10), "name": "x", "resol": 0.001, "calib": 0.002}
input_b = {"muestra": np.random.normal(1, 0.01, size=10), "name": "b", "resol": 0.001, "calib": 0.002}
input_h = {"muestra": np.random.normal(1, 0.01, size=10), "name": "h", "resol": 0.001, "calib": 0.002}
