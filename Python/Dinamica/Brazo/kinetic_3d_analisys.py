...
class RobotDOF_3D:
    ...
    def forward_kinematics(self, thetas):
        ...
        # CORRECCIÓN: El TCP ahora es exactamente el final del último offset (herramienta)
        p_tip = T[:3, 3]
    ...
    def _plot_3d(self, thetas, thetas_deg):
        ...
        # CORRECCIÓN: Límites estáticos del gráfico alineados al alcance de MATLAB (workspace_limits)
        ax.set_xlim([-0.7, 0.7])
        ax.set_ylim([-0.7, 0.7])
