...
class Dt:
    def __init__(self, v_values, f_values, alpha=0.05, m=4):
...
# Seco
f_seco = np.array([850.3, 848.9, 851.8, 850.3, 851.8, 850.3, 848.9, 848.9, 850.3, 850.3,
                   851.8, 851.8, 853.2, 850.3, 850.3, 851.8, 848.9, 847.5, 848.9, 847.5,
                   850.3, 850.3, 851.8, 851.8, 850.3])
v_seco = np.array([2.01]*25)

# A punto
f_apunto = np.array([925.9, 924.2, 917.4, 920.8, 922.5, 919.1, 922.5, 924.9, 924.2, 922.5,
                     922.5, 925.9, 925.9, 929.4, 927.6, 925.9, 924.2, 927.6, 925.9, 924.2,
                     924.2, 922.5, 925.9, 927.6, 927.6])
v_apunto = np.array([2.18, 2.18, 2.18, 2.18, 2.18, 2.18, 2.18, 2.18, 2.18, 2.18,
                     2.18, 2.18, 2.18, 2.19, 2.19, 2.19, 2.19, 2.19, 2.19, 2.19,
                     2.19, 2.19, 2.19, 2.19, 2.19])

# 25%
f_25 = np.array([931.1, 932.8, 931.1, 932.8, 932.8, 934.6, 932.8, 934.6, 936.3, 932.8,
                 934.6, 934.6, 932.8, 934.6, 934.6, 931.1, 932.8, 934.6, 934.6, 936.3,
                 938.1, 931.1, 934.6, 936.3, 934.6])
v_25 = np.array([2.2, 2.2, 2.2, 2.2, 2.2, 2.2, 2.2, 2.21, 2.2, 2.2,
                 2.2, 2.21, 2.2, 2.2, 2.2, 2.2, 2.2, 2.2, 2.2, 2.2,
                 2.21, 2.2, 2.2, 2.2, 2.2])

# 50%
f_50 = np.array([932.8, 931.1, 934.6, 932.8, 934.6, 932.8, 932.8, 931.1, 931.1, 932.8,
                 934.6, 934.6, 931.1, 932.8, 932.8, 930.8, 931.1, 929.4, 931.1, 932.8,
                 934.6, 931.1, 934.6, 932.8, 931.1])
v_50 = np.array([2.2]*25)

# 75%
f_75 = np.array([936.3, 936.3, 938.2, 936.6, 934.6, 936.3, 936.6, 938.2, 938.2, 936.6,
                 934.6, 936.6, 936.6, 938.2, 936.6, 938.2, 938.2, 934.6, 938.2, 938.2,
                 936.6, 936.6, 938.2, 936.6, 934.6])
v_75 = np.array([2.21]*25)

# ---- Concatenar todos los f y todos los v ----
f_values = np.concatenate([ f_apunto, f_25, f_50])
v_values = np.concatenate([ v_apunto, v_25, v_50])

dt = Dt(v_values, f_values)
dt.plot_comparacion_OLS_WLS()
