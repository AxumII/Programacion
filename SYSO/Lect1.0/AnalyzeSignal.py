...
class AnalyzeSignal:
    ...
    def analysis(self):
        ...
        peaks, _ = sg.find_peaks(autocorr, height=0.1)  # Ajusta el valor de "height" según tu caso
        ...
        c2 =  -rc_inv    
        Vs = +5030
        exponencial = expon(self.t, c1 ,c2) + Vs
...
if __name__ == "__main__":
    processor = AnalyzeSignal("Prueba2_1.csv")
