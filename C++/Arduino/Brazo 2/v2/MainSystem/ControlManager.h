...
public:
    ...
    bool moveA(float q1, float q2, float q3, float q4, float speed_deg_s);
    
    // --- Comandos MoveL (Velocidad en mm/s) ---
    bool moveL(float x, float y, float z, float speed_mm_s);    
    bool moveL(float x, float y, float z, float speed_mm_s, float phi_val);

    // --- Comandos MoveJ (Velocidad Cartesiana en mm/s, ejecutado articular) ---
    bool moveJ(float x, float y, float z, float speed_mm_s, bool elbowUp = true);    
    bool moveJ(float x, float y, float z, float speed_mm_s, float phi_val, bool elbowUp = true);
};
