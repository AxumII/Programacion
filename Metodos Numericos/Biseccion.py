...
class Biseccion:
    ...
    def __init__(self, equation, interv, iterat=100, error=1e-7):
    ...
    def solve(self, print_table=False):
        ...
        print("La raiz hallada en el intervalo es:",m)
        return m
...
iteraciones = 100
error_tol = 1e-7
c = Biseccion(eq, intervalo, iteraciones, error_tol)
c.solve(print_table=True)  # Ahora con print_table=True para imprimir la tabla
c.graf()  # Grafica la función y muestra la raíz encontrada
...
iteraciones = 100
error_tol = 1e-7
d = Biseccion(eq, intervalo, iteraciones, error_tol)
d.solve(print_table=True)  # Ahora con print_table=True para imprimir la tabla
d.graf()  # Grafica la función y muestra la raíz encontrada
